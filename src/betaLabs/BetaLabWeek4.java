...
public class BetaLabWeek4 {

	public static void main(String[] args) {
		
		//why would we use a StringBuilder instead of a String?
		
		//You would want to use a String Builder when you want to dynamically create a string that you can change, add, and remove.
		//you would only want to use a String if you want it to stay the same the whole time.
		...
		List<String> listOfStrings = new ArrayList<String>(); // there is an easier way by doing List<String> listOfStrings = Arrays.asList("RaceCar", "Funny", etc..);
		
		listOfStrings.add("RaceCar");
		listOfStrings.add("Funny");
		listOfStrings.add("Drinks");
		listOfStrings.add("Dentists");
		listOfStrings.add("Bat");
		
		//Write and test a method that takes a list of Strings and returns the list of string.
		System.out.println(findShortestString(listOfStrings));
		
		//Write and test a method the takes a list of strings and returns the list with the first and last element switched 
		List<String> swapped = swappedString(listOfStrings);
		...
		//Write and test a method that takes a list of strings and a string and returns a new list with all the strings from the original list
		//containing the second string parameter (i.e like a search method
		List<String> searchResults = search(listOfStrings, "t");
		for(String result : searchResults) {
			System.out.println(result);
		}
		
		//Write and test a method that takes a list of integers and returns a List of List<Integer> where the first list in the returned value
		...
		//Write and test a method that takes a list of strings and returns the list of integers that contains the length of each string
		List<Integer> stringsLengths = calculateStringLengths(listOfStrings);
	    ...
	    //input set that start with a character parameter
	    
	    Set<String> startsWitho = findAllThatStartWith (games, 'o');
	    ...
	    List<String> resultList = convertSetToList(games);
	    ...
	    Set<Integer> extractedEvens = sortEvenNumbers(integerSet);
	    ...
	    definitions.put("Candy", "A sweet food made with sugar.");
	    definitions.put("Honey", "a sweet, sticky yellowish-brown fluid made by bees");
	    definitions.put("Pepper", "a pungent, hot-tasting powder prepared from dried and ground peppercorns");
	    ...
	    String value = lookUpValue(definitions,"candy");
	...
	public static List<String> swappedString(List<String> list) {
	...
	public static Set<Integer> sortEvenNumbers(Set<Integer> set){
